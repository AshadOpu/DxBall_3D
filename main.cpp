...
float block_size_x = 1.3;
float block_size_y = .5;
...
float ball_accel_x = 0.002;
float ball_accel_y = 0.002;

float scene_left_x = -10;
float scene_right_x = 10;
float scene_top_y = 10;
float scene_bottom_y = -10;
...
void Create_Random_PowerUp(float px, float py)
{
    ...
    //int rand_power_up_type= generate_random(0,3);

    rand_power_up_type=2;
...
const GLfloat light_diffuse[]  = { 0.310f,  0.747f,  0.185f, 0.435f };
...
int main(int argc, char *argv[])
{
    ...
    glClearColor(0.014,  0.184,  0.576 , 1);
